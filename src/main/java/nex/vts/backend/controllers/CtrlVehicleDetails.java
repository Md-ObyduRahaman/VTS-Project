...
public class CtrlVehicleDetails {
    ...
    @GetMapping(value = "/{deviceType}/vehicle/{vehicleId}/details", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> getVehicleDetails(@PathVariable(value = "deviceType") Integer deviceType,
                                               @PathVariable(value = "vehicleId") Integer vehicleIds) throws SQLException, JsonProcessingException {
        ...
        Integer vehicleId = Math.toIntExact(deObfuscateId(Long.valueOf(vehicleIds)));
