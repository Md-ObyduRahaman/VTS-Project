...
import nex.vts.backend.models.vehicle.Vehicle_PermissionRowMapper;
import nex.vts.backend.models.vehicle.Vehicle_detailsRowMapper;
...
public class Vehicle_Details_Permission_Repo_Imp implements Vehicle_Details_Repo {
    ...
    @Override
    public List<Vehicle_Details> getVehicleDetails(Integer userType, Integer profileId, Integer vehicleId) {
        try {
            ...
            return jdbcTemplate.query(getQuery, new Vehicle_detailsRowMapper(), userType, profileId, vehicleId);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public Object getVehiclePermission(Integer userType, Integer profileId, Integer parentId, Integer vehicleId) {
        ...
        try {
            return jdbcTemplate.query(getQuery, new Vehicle_PermissionRowMapper(), userType, profileId, parentId, userType2, profileId2, parentId2, userType3, profileId3, parentId3, vehicleId);
        } catch (Exception e) {
            return e.getMessage();
        }
    }
