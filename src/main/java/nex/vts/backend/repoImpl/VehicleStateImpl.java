...
public class VehicleStateImpl implements VehicleStateRepo {
    ...
    @Override
    public Optional<ArrayList<VehicleStateInfoOra>> findVehicleStateInfoInfo(Integer parentProfileId,Integer userType,Integer userId,String SPECIFIC_VEHICLE_ID,int offSet,int rowLimit) {
